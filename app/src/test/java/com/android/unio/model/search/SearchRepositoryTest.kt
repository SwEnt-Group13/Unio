...
//          followersCount = 1,
//          members = listOf(Member(User.firestoreReferenceElementWith("1"), Role.GUEST.toString())),
...
//          followersCount = 1,
//          members = listOf(Member(User.firestoreReferenceElementWith("2"), Role.GUEST.toString())),
//          roles = listOf(Role.GUEST),
//          image = "https://www.example.com/image.jpg",
