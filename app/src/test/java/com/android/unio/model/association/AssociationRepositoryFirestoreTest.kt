  ...
  fun setUp() {
    ...
    map1 =
        mapOf(
            ...
            "members" to association1.members,
            "roles" to association1.roles,
    ...
    map2 =
        mapOf(
            ...
            "members" to association2.members,
            "roles" to association2.roles,
    ...
    repository.getAssociations(
        onSuccess = { associations ->
          ...
          assertEquals("", associations[1].description)
            assertEquals(emptyList<String>(), associations[1].members.map{it.uid}.toSet())
        },
        onFailure = { exception -> assert(false) })
  }
