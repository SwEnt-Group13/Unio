...
class CreateAndEditAssociationTest : EndToEndTest() {
    ...
    fun testCreateAndEditAssociation() {
        ...
        composeTestRule.onNodeWithTag(SaveAssociationTestTags.CANCEL_BUTTON).performScrollTo() //try to cancel
        ...
        composeTestRule.onNodeWithTag(SaveAssociationTestTags.NAME_TEXT_FIELD).assertDisplayComponentInScroll()
        ...
        composeTestRule.onNodeWithTag(SaveAssociationTestTags.NAME_TEXT_FIELD).performTextInput("NameAssociation")

        composeTestRule.onNodeWithTag(SaveAssociationTestTags.FULL_NAME_TEXT_FIELD).assertDisplayComponentInScroll()
        composeTestRule.onNodeWithTag(SaveAssociationTestTags.FULL_NAME_TEXT_FIELD).performScrollTo()
        composeTestRule.onNodeWithTag(SaveAssociationTestTags.FULL_NAME_TEXT_FIELD).performTextClearance()
        composeTestRule.onNodeWithTag(SaveAssociationTestTags.FULL_NAME_TEXT_FIELD).performTextInput("FullNameAssociation")

        composeTestRule.onNodeWithTag(SaveAssociationTestTags.DESCRIPTION_TEXT_FIELD).assertDisplayComponentInScroll()
        composeTestRule.onNodeWithTag(SaveAssociationTestTags.DESCRIPTION_TEXT_FIELD).performScrollTo()
        composeTestRule.onNodeWithTag(SaveAssociationTestTags.DESCRIPTION_TEXT_FIELD).performTextClearance()
        composeTestRule.onNodeWithTag(SaveAssociationTestTags.DESCRIPTION_TEXT_FIELD).performTextInput("DescriptionAssociation")
        ...
        composeTestRule.onNodeWithTag(SaveAssociationTestTags.URL_TEXT_FIELD).assertDisplayComponentInScroll()
        ...
        composeTestRule.onNodeWithTag(SaveAssociationTestTags.URL_TEXT_FIELD).performTextInput("URLAssociation")

        composeTestRule.onNodeWithTag(SaveAssociationTestTags.PRINCIPAL_EMAIL_ADDRESS_TEXT).assertDisplayComponentInScroll()
        composeTestRule.onNodeWithTag(SaveAssociationTestTags.PRINCIPAL_EMAIL_ADDRESS_TEXT).performScrollTo()
        composeTestRule.onNodeWithTag(SaveAssociationTestTags.PRINCIPAL_EMAIL_ADDRESS_TEXT).performTextClearance()
        composeTestRule.onNodeWithTag(SaveAssociationTestTags.PRINCIPAL_EMAIL_ADDRESS_TEXT).performTextInput("URLAssociation")
