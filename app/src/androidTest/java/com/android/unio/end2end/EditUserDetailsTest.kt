...
class EditUserDetailsTest : EndToEndTest() {
    ...
    fun testUserModifiesHisAccountDetails(){
        ...
        composeTestRule.onNodeWithTag(UserEditionTestTags.LAST_NAME_TEXT_FIELD).performTextInput("Watson")
        ...
        composeTestRule.onNodeWithTag(UserEditionTestTags.BIOGRAPHY_TEXT_FIELD).performTextInput("This is my new Bio")
        ...
        allInterests.forEachIndexed { _, index ->
            composeTestRule.onNodeWithTag(UserEditionTestTags.INTERESTS_CHIP + "$index")
        ...
        composeTestRule.onNodeWithTag(UserProfileTestTags.NAME).performScrollTo().assertTextEquals("Eva Watson")
        composeTestRule.onNodeWithTag(UserProfileTestTags.BIOGRAPHY).performScrollTo().assertTextEquals("This is my new Bio")

        //Check that all new interests have been added
        allInterests.filter { it == Interest.ART || it == Interest.TRAVEL}
        allInterests.forEach {interest ->
            composeTestRule.onNodeWithTag(UserProfileTestTags.INTEREST_CHIP + interest.title)
                .assertExists()
        }
