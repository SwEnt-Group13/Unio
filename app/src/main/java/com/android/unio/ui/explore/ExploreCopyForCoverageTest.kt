...
fun ExploreScreenCopy(
  ...
  Scaffold(
      ...
      content = { padding ->
        ExploreScreenContentCopy(padding, navigationAction, associationViewModel, searchViewModel)
      })
}
                ...
                LazyRow(
                    ...
                    verticalAlignment = Alignment.CenterVertically) {
                      items(alphabeticalAssociations.size) { index ->
                        AssociationItemCopy(alphabeticalAssociations[index]) {
 ...
 */
@Composable
fun AssociationItemCopy(association: Association, onClick: () -> Unit) {
  val context = LocalContext.current
  Column(
      modifier =
...
fun getSortedEntriesAssociationsByCategoryCopy(
