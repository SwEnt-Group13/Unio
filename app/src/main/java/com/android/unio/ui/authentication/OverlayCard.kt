...
fun InterestOverlay(
    ...
    Dialog(
        ...
        Card(
            ...
            Column(
                modifier = Modifier
                    .fillMaxWidth().padding(15.dp).sizeIn(maxHeight = 400.dp),
                ...
                Surface (
                    modifier = Modifier.sizeIn(maxHeight = 250.dp),
                    ...
                    Column(
                        ...
                        interestsState.forEachIndexed{ index, pair ->
                            Row(
                                ...
                                modifier = Modifier.padding(5.dp).fillMaxWidth().clickable { pair.second.value = !pair.second.value }
                            ) {
                                Text(
