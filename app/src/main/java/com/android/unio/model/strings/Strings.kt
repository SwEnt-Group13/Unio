...
object TextLengthSamples{
  ...
  //90 characters
  const val MEDIUM = "A wonderful serenity has taken possession of my entire soul, like these sweet mornings of."

  //280 characters
  const val LARGE = "A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which " +
